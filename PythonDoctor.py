...
class EventType(enum): #This is a list of all the event types in the game. 1st value is the name, 2nd value is the category, 3rd value is the number of arguments. This is for ease of use.
    ...
    Comment = ("Comment", Category.VFX, 3)
    Tint = ("Tint", Category.VFX, 4)
    ...
    ShowDialogue = ("ShowDialogue", Category.VFX, 5)
    ShowStatusSign = ("ShowStatusSign", Category.VFX, 3)
    FloatingText = ("FloatingText", Category.VFX, 7)
    ChangePlayersRows = ("ChangePlayersRows", Category.Rows, 4)
    FinishLevel = ("FinishLevel", Category.VFX, 0)
    PlayAnimation = ("PlayAnimation", Category.VFX, 2)
    ReorderRooms = ("ReorderRooms", Category.Rooms, 1)
    Stutter = ("Stutter", Category.VFX, 5)
    ShowHands = ("ShowHands", Category.VFX, 5)
    PaintHands = ("PaintHands", Category.VFX, 4)
    SetHandOwner = ("SetHandOwner", Category.VFX, 3)
    SetPlayStyle = ("SetPlayStyle", Category.VFX, 3)
    TagAction = ("TagAction", Category.VFX, 2)
    CallCustomMethod = ("CallCustomMethod", Category.VFX, 3)
    NewWindowDance = ("NewWindowDance", Category.VFX, 5)
